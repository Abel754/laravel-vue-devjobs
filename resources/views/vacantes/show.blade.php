    ...
    <div class="mt-10 mb-20 md:flex items-start">
        <div class="md:w-3/5 bg-gray-100">
            <p class="block text-gray-700 font-bold my-2">
                <!-- diffForHumans() -> Mostrarà la fecha d'una bona manera (Hace 3 días...) -->
                Publicado: <span class="font-normal">{{$vacante->created_at->diffForHumans()}}</span>
                <!-- Posem reclutador perquè és el mètode que relaciona al model Vacante amb User -->
            ...
            <p class="block text-gray-700 font-bold my-2">
                Salario: <span class="font-normal">{{$vacante->ubicacion->nombre}}</span>
            </p>
            <p class="block text-gray-700 font-bold my-2">
                Salario: <span class="font-normal">{{$vacante->experiencia->nombre}}</span>
            </p>
            ...
            <!-- Utilitzem lightbox per mostrar imatges -->
        ...
        <!-- Si està activa- mostra-ho -->
        @if($vacante->activa === 1)
            @include('ui.contacto') <!-- Lloc on es troba el formulari -->
        @endif
    </div>
