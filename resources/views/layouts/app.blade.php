...
<body class="bg-gray-200 min-h-screen leading-none">
    ...
    <!-- Imprimim la variable estado creada en el return with del mètode store de CandidatoController-->
    @if(session('estado'))
    ...
    <div id="app">
                    ...
                    <a class="text-2xl text-white" href="{{ url('/') }}">
                        ...
                        <nav class="flex-1 text-right">
                            ...
                            @else
                                        ...
                                        <!-- El següent codi permet mostrar les notificacions que l'usuari no ha llegit. Havent creat primer el tema de notificacions -->
                                        <a
                                        ...
                                        <a class="no_underline hover:underline text-gray-300 text-sm p-3" href="{{ route('logout') }}"
        ...
        <div class="bg-gray-700">
            <nav class="conrtainer mx-auto flex space-x-1 flex-col text-center md:flex-row">
                @yield('navegacion')
            </nav>
        </div>
