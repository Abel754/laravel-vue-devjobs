                ...
                <div class="bg-gray-300 text-gray-700 uppercase text-center py-3 px-6 mb-0">
                    ...
                    <form class="py-10 px-5" method="POST" action="{{ route('login') }}" novalidate>
                        ...
                        <div class="flex flex-wrap mb-6">
                                    ...
                                    <label class="block text-gray-700 tet-sm mb-2" for="remember">
                                        {{ __('Remember Me') }}
                                    </label>
                        </div>

                        <div class="flex flex-wrap">
                                <button type="submit" class="bg-teal-500 w-full hover:bg-teal-700 text-gray-100 p-3 focus:outline-none focus:shadow-outline uppercase font-bold mb-5">
                                    {{ __('Login') }}
                                </button>

                                @if (Route::has('password.request'))
                                    <a class="text-sm text-gray-500 text-center w-full mb-5" href="{{ route('password.request') }}">
