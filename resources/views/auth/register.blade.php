...
<div class="container mx-auto">
    <div class="flex flex-wrap justify-center">
        <div class="md:w-1/2 order-2 md:order-1"> <!-- Aquesta classe divideix la pantalla en dos divs -->
                    ...
                    <div class="bg-gray-300 text-gray-700 uppercase text-center py-3 px-6 mb-0">
                        ...
                        <form class="py-10 px-5" method="POST" action="{{ route('register') }}" novalidate>
                            ...
                            <div class="flex flex-wrap mb-6">
                                <label for="name" class="block text-gray-700 tet-sm mb-2">{{ __('Name') }}</label>
                            ...
                            <div class="flex flex-wrap mb-6">
                                <label for="email" class="block text-gray-700 tet-sm mb-2">{{ __('E-Mail Address') }}</label>
                            ...
                            <div class="flex flex-wrap mb-6">
                                <label for="password" class="block text-gray-700 tet-sm mb-2">{{ __('Password') }}</label>
                            ...
                            <div class="flex flex-wrap mb-6">
                                <label for="password-confirm" class="block text-gray-700 tet-sm mb-2">{{ __('Confirm Password') }}</label>
        ...
        <div class="md:w-1/2 order-2 md:order-2 text-center flex flex-col justify-center px-10 mt-10">
