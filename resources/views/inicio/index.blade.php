...
@section('content')
    <div class="flex flex-col lg:flex-row shadow bg-white">
        <div class="lg:w-1/2 px-8 lg:px-12 py-12 lg:py-24">
            ...
            <h1 class="mt-2 sm:mt-4 text-3xl font-bold text-gray-700 leading-light">
                Encuentra un trabajo remoto o en tu país
                <span class="text-teal-500 block">Para Desarrollades / Diseñadores Web</span>
            </h1>

            @include('ui.buscar')
        </div>

        <!-- Si aquest div creix, farà que la imatge no perdi proporció -->
